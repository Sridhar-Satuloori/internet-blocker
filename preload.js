...
contextBridge.exposeInMainWorld('blocker', {
  ...
  applyDomainPack: (packId, options) => ipcRenderer.invoke('apply-domain-pack', packId, options),
  getDefaultsMeta: () => ipcRenderer.invoke('get-defaults-meta'),
  ...
  readLog: (options) => ipcRenderer.invoke('read-log', options),
